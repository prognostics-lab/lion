...
float lion_sum_float(float *vals, size_t count);
double lion_sum_double(double *vals, size_t count);
...
float lion_polyval_float(float x, float *coeffs, u32 count);
double lion_polyval_double(double x, double *coeffs, u32 count);
