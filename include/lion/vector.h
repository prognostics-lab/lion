...
///
/// @param[in]  sim        Simulation context, can be NULL.
...
int8_t        lion_vector_get_i8(lion_sim_t *sim, const lion_vector_t *vec, const size_t i);
...
uint8_t       lion_vector_get_u8(lion_sim_t *sim, const lion_vector_t *vec, const size_t i);
...
float         lion_vector_get_f(lion_sim_t *sim, const lion_vector_t *vec, const size_t i);
double        lion_vector_get_d(lion_sim_t *sim, const lion_vector_t *vec, const size_t i);
void         *lion_vector_get_p(lion_sim_t *sim, const lion_vector_t *vec, const size_t i);
...
lion_status_t lion_vector_push_d(lion_sim_t *sim, lion_vector_t *vec, double src);
lion_status_t lion_vector_push_f(lion_sim_t *sim, lion_vector_t *vec, float src);
