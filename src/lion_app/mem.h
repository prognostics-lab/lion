...
void *_lion_malloc(lion_app_t *app, size_t size, const char *filename, int line);
void *_lion_realloc(lion_app_t *app, void *ptr, size_t new_size, const char *filename, int line);
void *_lion_calloc(lion_app_t *app, size_t num, size_t size, const char *filename, int line);
