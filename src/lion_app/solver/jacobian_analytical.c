...
double jac_0_t_analytical(lion_app_state_t *state, lion_params_t *params) { return 0.0; }

double jac_1_t_analytical(lion_app_state_t *state, lion_params_t *params) { return 0.0; }
